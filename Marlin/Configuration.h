...
#define STRING_CONFIG_H_AUTHOR "(BCN Dynamics, Maduixa CNC)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_13_MADUIXA
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 2560*2,2560*2,2560*2,10 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 5, 5, 4, 25 }
